...
<style>
    ...
    /* ==============================================
       ...
       ============================================== */
    /* Background pembungkus semua tab */
    ...
    /* Bentuk tombol tab dasar (Belum diklik) */
    .stTabs [data-baseweb="tab"] {
        background-color: #ffffff !important;
        border-radius: 10px !important;
        padding: 10px 25px !important;
        border: 2px solid #cbd5e1 !important; /* INI BATAS WARNANYA */
    ...
    /* Warna saat tab aktif/diklik (Menyala) */
...
# ==========================================
# 5. HEADER BANNER APLIKASI (DIJAMIN MUNCUL CANTIK)
# ==========================================
# Menggunakan Inline CSS di HTML agar Streamlit TIDAK BISA menimpanya!
st.markdown("""
